...
for course_code in glob.glob('*.html'):
    ...
    try:
        ...
        for i, this_class_index in enumerate(ClassID_Indexes):
            ...
            SectionID = find_key('SectionID', this_class).split(' ')[1][1:]
            ...
            TimeStart += 'AM' if (int(TimeStart[:2]) < 12) else 'PM'
            ...
            # BUILDING
            try:
                db_building = Building.get(Building.BuildingName == BuildingName)
            except:
                db_building = Building.create(BuildingName=BuildingName)
            ...
            try:
                ...
                print "db_building: " + db_building.BuildingName
